        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="mx-3 welcome-text">
                    <h3 class="mb-0 fw-bold text-truncate">{{ $user->first_name . ' ' .$user->last_name }}</h3>
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        ...
                        <form action="{{ route('org.profile.edit') }}" method="POST">
                            @csrf
                            <button href="{{ route('org.profile.edit') }}" class="dropdown-item"><i
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button href="{{ route('logout') }}" class="dropdown-item text-danger"><i
